...
typedef enum Token { EMPTY = 0, YELLOW = 1, RED = 2 } Token;
...
bool check_win_condition() { return false; }

// will add the token, check the winning condition and return it
bool update_board(Game *game, int col, int current_player) { return false; }
